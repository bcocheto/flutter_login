...
class _LoginPageState extends State<LoginPage>
  ...
  static TextEditingController _snameController = new TextEditingController();
  ...
  String get sname => _snameController.text;

  String get email => _emailController.text;

  String get pass => _passwordController.text;
    ...
    try {
      ...
      if (user != null) {
        ...
        Firestore.instance
            .collection('users')
            .document('$uid')
            .setData({'name': '$name', 'sname': '$sname', 'email': '$semail'});
  ...
  void doLogin(BuildContext context) async {
    try {
      ...
      if (user != null) {
        ...
        FirebaseNavigator.goToHome(context);
      }
